...
void SoftwareSerial::begin(long speed)
{
  ...
  _tx_delay = subtract_cap(bit_delay, 15 / 4);
    ...
    if (115200L == speed)
    {
        _rx_delay_centering = 15;
        _rx_delay_firstbit = 37;
        _rx_delay_intrabit = 37;
        _rx_delay_stopbit = 37;
        _tx_delay = 37;
    }
    else if (57600L == speed)
    {
        _rx_delay_centering = 40;
        _rx_delay_firstbit = 83;
        _rx_delay_intrabit = 83;
        _rx_delay_stopbit = 83;
        _tx_delay = 83;
    }
    else if (38400L == speed)
    {
        _rx_delay_centering = 62;
        _rx_delay_firstbit = 129;
        _rx_delay_intrabit = 129;
        _rx_delay_stopbit = 129;
        _tx_delay = 129;
    }
    else if (19200L == speed)
    {
        _rx_delay_centering = 130;
        _rx_delay_firstbit = 268;
        _rx_delay_intrabit = 268;
        _rx_delay_stopbit = 268;
        _tx_delay = 268;
    }
    else if (9600L == speed)
    {
        _rx_delay_centering = 260;
        _rx_delay_firstbit = 544;
        _rx_delay_intrabit = 544;
        _rx_delay_stopbit = 544;
        _tx_delay = 544;
    }
    else if (4800L == speed)
    {
        _rx_delay_centering = 500;
        _rx_delay_firstbit = 1100;
        _rx_delay_intrabit = 1100;
        _rx_delay_stopbit = 1100;
        _tx_delay = 1100;
    }
...
#if defined(G23_FPB) || defined(G24_FPB) 
    if (0!=p->ccde){
        CCDE &= (uint8_t)~(p->ccde);
    }
#endif // G23_FPB || defined(G24_FPB) 
