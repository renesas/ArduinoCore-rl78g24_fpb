...
extern "C" {
  ...
  extern volatile uint16_t g_csi10_tx_count;
...
#if     defined(CSI_CHANNEL2) && CSI_CHANNEL2 == 2
  case 2:
    Master_Create_          = R_Config_CSI10_Create;
    Master_Start_           = R_Config_CSI10_Start;
    Master_Stop_            = R_Config_CSI10_Stop;
    Master_Create_UserInit_ = R_Config_CSI10_Create_UserInit;
    Master_ClearStatus_     = R_Config_CSI10_ClearStatus;
    Master_Send_Receive_    = R_Config_CSI10_Send_Receive;
    Master_SetBitOrder_     = R_Config_CSI10_SetBitOrder;
    Master_SetDataMode_     = R_Config_CSI10_SetDataMode;
    Master_SetClockDivider_ = R_Config_CSI10_SetClockDivider;
    Master_SetClock_        = R_Config_CSI10_SetClock;
    Master_GetBitOrder_     = R_Config_CSI10_GetBitOrder;
    master_tx_count         = &g_csi10_tx_count;
    master_status_flag      = &g_csi10_status_flag;
    break;
