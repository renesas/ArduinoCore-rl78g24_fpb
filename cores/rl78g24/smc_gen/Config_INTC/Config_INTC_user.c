...
void r_Config_INTC_intp1_interrupt(void)
{
    ...
    if (g_afInterruptFuncTable[9] != NULL) {
        (*g_afInterruptFuncTable[9])();
    }
    /* End user code. Do not edit comment generated here */
}
...
void r_Config_INTC_intp2_interrupt(void)
{
    ...
    if (g_afInterruptFuncTable[10] != NULL) {
        (*g_afInterruptFuncTable[10])();
    }
    /* End user code. Do not edit comment generated here */
}
...
void r_Config_INTC_intp3_interrupt(void)
{
    ...
    if (g_afInterruptFuncTable[11] != NULL) {
        (*g_afInterruptFuncTable[11])();
    }
    /* End user code. Do not edit comment generated here */
}
...
void r_Config_INTC_intp4_interrupt(void)
{
    ...
    if (g_afInterruptFuncTable[12] != NULL) {
        (*g_afInterruptFuncTable[12])();
    }
    /* End user code. Do not edit comment generated here */
}
...
/***********************************************************************************************************************
* Function Name: r_Config_INTC_intp20_interrupt
* Description  : This function is INTP20 interrupt service routine.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void r_Config_INTC_intp20_interrupt(void)
{
    /* Start user code for r_Config_INTC_intp20_interrupt. Do not edit comment generated here */
...
/***********************************************************************************************************************
* Function Name: r_Config_INTC_intp21_interrupt
* Description  : This function is INTP21 interrupt service routine.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void r_Config_INTC_intp21_interrupt(void)
{
    /* Start user code for r_Config_INTC_intp21_interrupt. Do not edit comment generated here */
