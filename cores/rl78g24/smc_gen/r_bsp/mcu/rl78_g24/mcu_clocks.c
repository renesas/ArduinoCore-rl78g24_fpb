        ...
        case PLLCLK:
            ...
            if (0U == DSCON)
            {
                ...
                else
                {
                    ...
                    /* WAIT_LOOP */
                    for (w_count = 0U; w_count <= BSP_CFG_LOCKUP_WAIT_COUNT_SEL; w_count++)
                    {
                        BSP_NOP();
                    }
                }
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                sys_clock_src_freq = g_fih_hz[(temp1 << 5U) | (temp2 & 0x18U) | (temp3 & 0x07U)];
            }
        }
...
void mcu_clock_setup(void)
{
    ...
    CKSELR = BSP_CFG_PLL_MODE;

    while (BSP_CFG_PLL_MODE !=  CLSTR)
    {
        ;
    }
